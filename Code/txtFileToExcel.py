...
This code assumes that the text files are formatted in a way that can be loaded by pandas, and that the column name for the averages row is "Averages" and has to be in the third column. used the "iloc" property of the Dataframe to extract the second column, which is the column containing the averages.
"""
import xlwt
import pandas as pd
...
# Extract averages from the third column 
avg1 = data1.iloc[:, 2]
avg2 = data2.iloc[:, 2]
