...
# Dwell times
	Dwell_T_change = 200. *picoseconds # 200. 
	Dwell_init_anneal = 2. * nanoseconds  # 2.0
	Dwell_anneal = 2. * nanoseconds  # 2.0
	Dwell_equilibrate = 5. * nanoseconds  # 5.0
...
# Trajectory Length & Repeat
	...
	Trajectory_time = 5.0 * nanoseconds  # 5.0 
...
# Set up for system, NoCutof for Amoeba, Constrain only x-H bond lengths
	...
	forcefield = ForceField('../AMOEBAff/water_amoeba18.xml', '../AMOEBAff/ions.xml', '../AMOEBAff/ctc.xml', '../AMOEBAff/surfactants.xml')
